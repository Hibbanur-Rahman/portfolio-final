        ...
        <div className="space-y-8 order-2 lg:order-1">
          ...
          >
            {[
              ...
              { icon: MapPin, label: "Location", value: "Gachibowli, Hyderabad, India", span: "sm:col-span-2 lg:col-span-1 xl:col-span-2" }
            ].map((contact, index) => (
              <motion.div 
                key={contact.label}
          ...
          >
            {[
              { icon: Github, href: "https://github.com/Hibbanur-Rahman", label: "GitHub" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/hibbanur-rahman/", label: "LinkedIn" }
            ].map((social, index) => (
              <motion.div
                key={social.label}
